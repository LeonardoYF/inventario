...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <!-- form start -->
        <form action="{{ route('detalles.update',$detalle->id_detalle_ingreso)}}" method="POST" class="form">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="form-group">
                            ...
                            <input value="{{$detalle->precio_compra}}" type="number" class="form-control" step="0.01" min="0" name="precio_compra" id="precio_compra" placeholder="Precio_compra">
                        </div>
                    </div>
                    <div class="col-md-4 col-6">
                        <div class="form-group">
                            <label for="pprecio_venta">P_Venta</label>
                            <input value="{{$detalle->precio_venta}}" type="number" class="form-control" step="0.01" min="0" name="precio_venta" id="precio_venta" placeholder="Precio_compra">
                        </div>
                    </div>
